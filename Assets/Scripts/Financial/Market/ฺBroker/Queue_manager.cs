...
public class Queue_manager : MonoBehaviour
{
    ...
    public void addQueueOrder(string market_name, int item_id,OrderOperation customer, string broker_name, LimitOrder limitOrder, int status)
    {
    ...
    {
        int queueIndex = QueueOrder(market_name, item_id);
